...
__constant__ hemelb::site_t _Iolets_Inlet_Edge[local_iolets_MaxSIZE];
__constant__ hemelb::site_t _Iolets_InletWall_Edge[local_iolets_MaxSIZE];
__constant__ hemelb::site_t _Iolets_Inlet_Inner[local_iolets_MaxSIZE];
__constant__ hemelb::site_t _Iolets_InletWall_Inner[local_iolets_MaxSIZE];
__constant__ hemelb::site_t _Iolets_Outlet_Edge[local_iolets_MaxSIZE];
__constant__ hemelb::site_t _Iolets_OutletWall_Edge[local_iolets_MaxSIZE];
...
#define SYM_COPY(sym, src, sz) \
		e = hipGetSymbolAddress(&sym_ptr, HIP_SYMBOL(sym)); \
		if (e != hipSuccess) { fprintf(stderr, "hipGetSymbolAddress(" #sym "): %s\n", hipGetErrorString(e)); return false; } \
